...
async function main() {
  ...
  const linguagens = await prisma.disciplina.create({
    data: {
      nome: "linguagens",
      subdisciplinas: {
        create: [
  ...
  // Agora insere questões vinculadas a disciplina e subdisciplina

  // Pegando o id da subdisciplina geometria da matemática
  ...
  const espanhol = linguagens.subdisciplinas.find((s) => s.nome === "espanhol");
  ...
  await prisma.questao.createMany({
    data: [
      ...
      },
      {
        ...
        alternativa_c: "Escassez de oportunidades de aprendizado do espanhol.",
        alternativa_d:
      ...
      },
      {
        ...
        alternativa_d: "Informar a transferência de seu livro a outra editora.",
  ...
  console.log("Banco populado com disciplinas, subdisciplinas e questões.");
}
