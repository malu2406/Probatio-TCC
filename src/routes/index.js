...
router.post(
  "/api/estatisticas",
  checkAuth,
  statisticsController.postStatistics
);
router.delete(
  "/api/estatisticas",
  checkAuth,
...
router.get(
  "/api/estatisticas-disciplinas",
  checkAuth,
  statisticsController.getStatisticsByDiscipline
);
router.get(
  "/api/debug-estatisticas",
  checkAuth,
  statisticsController.debugStatistics
);
